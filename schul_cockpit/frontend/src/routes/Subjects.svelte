...
<style>
  ...
  .trend{text-align:center;display:grid;gap:2px;justify-items:center;color:var(--accent)}.trend svg{width:72px;height:26px}.trend-text{color:var(--rating-3)!important;font-weight:600}.trend-down .trend-text{color:var(--rating-1)!important}.chevron{color:var(--accent);transition:transform .15s}.chevron.opened{transform:rotate(90deg)}
