...
<div class="mentor">
  ...
  {#if running}
    ...
    <h1>{running.goal}</h1>
    {#if running.task && running.status==='active'}<details class="task" open><summary>Deine aktuelle Aufgabe</summary><p class="preserve">{running.task.prompt}</p></details>{/if}
