...
_ACCOUNT_TABLES = (
    "packing_items", "reminder_settings", "reminder_deliveries", "digital_textbook_credentials", "digital_textbook_catalog",
    "digital_textbook_pages", "digital_textbook_fetches", "digital_textbook_access", "source_links", "book_chapters", "entry_chapters",
