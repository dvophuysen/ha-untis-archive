...
TOPIC_RULE=('topic ist ein Thema der offiziellen Themenliste der Lehrkraft für eine Arbeit. Übe dieses Thema. '
            ...
            'Geübt wird die Fähigkeit des Themas und sonst nichts. Alles, was eine Aufgabe darüber hinaus voraussetzt — ein Sachverhalt, eine Zahl, eine Angabe aus einem anderen Fach, ein Begriff, der noch nicht dran war —, gibst du in der Aufgabe vor, statt es stillschweigend mitzuprüfen; sonst scheitert das Kind an etwas, das gar nicht geübt werden sollte. Im Sprachunterricht heißt das: Die Fähigkeit ist die Sprache, nicht der Sachverhalt, über den gesprochen wird. '
