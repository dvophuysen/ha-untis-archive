...
- 1.22.0: Übungsarbeiten und Raster Thema × Anforderungsbereich (D178, `practice.py`, `routers/practice.py`, `PracticeRaster.svelte`), Wochenend-Regel (D179). Offen: Stufen B und C aus D178/D179.
