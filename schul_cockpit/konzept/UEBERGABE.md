...
- Kosten: Cachefreundliche Reihenfolge und Token-Erfassung seit 1.13.15 (D149). Ab 01.10. auswerten (`GET /api/accounts/{id}/learning/mentor` als Elternteil → `budget.tokens`), dann Mentor-Kontext entschlacken; Structured Output offen. Modellanträge für Foundry 2: gpt-5.1 als „hoch“, gpt-5-nano, mehr TPM für gpt-5-mini.
