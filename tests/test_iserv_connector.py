...
def test_login_page_detection():
    assert _looks_like_login("https://gaw-iserv.de/iserv/auth/login", "")
    assert _looks_like_login("https://gaw-iserv.de/iserv/", '<input name="_username"><input name="_password">')
    assert not _looks_like_login("https://gaw-iserv.de/iserv/", "Willkommen")
