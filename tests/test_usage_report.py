...
def fill():
    with closing(db.webapp_conn()) as c, c:
        c.executescript(
            # Einheit 5 (offen) mit viel Hilfe: vier Hilfeanfragen in sechs Nachrichten, spät am Abend.
            "INSERT INTO mentor_messages(account_id,session_id,request_key,role,text,payload,created_at) VALUES"
            " (1,5,'u1','user','Nr. 3?','{\"kind\":\"message\"}','2026-09-17T22:10:00+02:00'),"
            " (1,5,'u2','user','kp','{\"kind\":\"hint\"}','2026-09-17T22:12:00+02:00'),"
            " (1,5,'u3','user','und weiter?','{\"kind\":\"hint\"}','2026-09-17T22:14:00+02:00'),"
            " (1,5,'u4','user','Beispiel','{\"kind\":\"example\"}','2026-09-17T22:16:00+02:00'),"
            " (1,5,'u5','user','weiter','{\"kind\":\"hint\"}','2026-09-17T22:18:00+02:00'),"
            " (1,5,'u6','user','ok','{\"kind\":\"answer\"}','2026-09-17T22:20:00+02:00');"
